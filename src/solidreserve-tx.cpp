...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("solidreserve Core solidreserve-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  solidreserve-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded solidreserve transaction") + "\n" +
                               "  solidreserve-tx [options] -create [commands]   " + _("Create hex-encoded solidreserve transaction") + "\n" +
                               "\n";
...
static void MutateTxAddOutAddr(CMutableTransaction& tx, const string& strInput)
{
    ...
    CSolidreserveAddress addr(strAddr);
    if (!addr.IsValid())
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded solidreserve transaction
