...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CSolidreserveAddress demoAddress = CSolidreserveAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CSolidreserveAddress setaccountDemoAddress = CSolidreserveAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CSolidreserveAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CSolidreserveAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
