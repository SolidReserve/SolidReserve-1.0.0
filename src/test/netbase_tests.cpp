// Copyright (c) 2012-2014 The Solidreserve Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.solidreserve.org", "www.solidreserve.org", -1));
    BOOST_CHECK(TestSplitHost("[www.solidreserve.org]", "www.solidreserve.org", -1));
    BOOST_CHECK(TestSplitHost("www.solidreserve.org:80", "www.solidreserve.org", 80));
    BOOST_CHECK(TestSplitHost("[www.solidreserve.org]:80", "www.solidreserve.org", 80));
