...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop solidreserve server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "solidreserve server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* solidreserve features */
        {"solidreserve", "masternode", &masternode, true, true, false},
        {"solidreserve", "masternodelist", &masternodelist, true, true, false},
        {"solidreserve", "mnbudget", &mnbudget, true, true, false},
        {"solidreserve", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"solidreserve", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"solidreserve", "mnsync", &mnsync, true, true, false},
        {"solidreserve", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"solidreserve", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use solidreserved, or the -server option to solidreserve-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> solidreserve-cli " + methodname + " " + args + "\n";
}
