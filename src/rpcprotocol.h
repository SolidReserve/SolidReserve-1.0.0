...
#ifndef SOLIDRESERVE_RPCPROTOCOL_H
#define SOLIDRESERVE_RPCPROTOCOL_H
...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! solidreserve is not connected
...
#endif // SOLIDRESERVE_RPCPROTOCOL_H
