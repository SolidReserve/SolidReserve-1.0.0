...
#ifndef SOLIDRESERVE_ARITH_UINT256_H
#define SOLIDRESERVE_ARITH_UINT256_H
...
public:
     ...
     *
     * Solidreserve only uses this "compact" format for encoding difficulty
