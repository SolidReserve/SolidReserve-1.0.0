 ...
 */
#ifndef SOLIDRESERVE_UTIL_H
#define SOLIDRESERVE_UTIL_H
...
extern int nAnonymizesolidreserveAmount;
...
{
    std::string s = strprintf("solidreserve-%s", name);
