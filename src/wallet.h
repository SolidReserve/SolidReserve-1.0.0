...
#ifndef SOLIDRESERVE_WALLET_H
#define SOLIDRESERVE_WALLET_H
...
public:
    ...
    std::map<CSolidreserveAddress, std::vector<COutput> > AvailableCoinsByAddress(bool fConfirmed = true, CAmount maxCoinValue = 0);
