...
#ifndef SOLIDRESERVE_QT_SOLIDRESERVEUNITS_H
#define SOLIDRESERVE_QT_SOLIDRESERVEUNITS_H
...
/** solidreserve unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SolidreserveUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SolidreserveUnits(QObject* parent);

    /** solidreserve units.
      @note Source: https://en.solidreserve.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        PIE,
        mPIE,
...
typedef SolidreserveUnits::Unit SolidreserveUnit;

#endif // SOLIDRESERVE_QT_SOLIDRESERVEUNITS_H
