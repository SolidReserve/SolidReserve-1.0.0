...
#ifndef SOLIDRESERVE_QT_SENDCOINSDIALOG_H
#define SOLIDRESERVE_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending solidreserves */
...
#endif // SOLIDRESERVE_QT_SENDCOINSDIALOG_H
