...
#ifndef SOLIDRESERVE_QT_WALLETMODEL_H
#define SOLIDRESERVE_QT_WALLETMODEL_H
...
/** Interface to Solidreserve wallet from Qt view code. */
...
public:
    ...
    bool isMine(CSolidreserveAddress address);
...
#endif // SOLIDRESERVE_QT_WALLETMODEL_H
