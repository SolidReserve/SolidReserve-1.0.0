...
/* Window elements init */
    ...
    ui->unit->setModel(new SolidreserveUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->solidreserveAtStartup, OptionsModel::StartAtStartup);
...
/* Window */
    ...
    mapper->addMapping(ui->anonymizesolidreserve, OptionsModel::AnonymizesolidreserveAmount);
