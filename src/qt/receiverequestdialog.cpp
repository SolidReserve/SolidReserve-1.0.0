...
#include "config/solidreserve-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatSolidreserveURI(info);
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " + SolidreserveUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatSolidreserveURI(info));
}
