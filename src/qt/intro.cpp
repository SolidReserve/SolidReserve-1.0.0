...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        intro.setWindowIcon(QIcon(":icons/solidreserve"));
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("solidreserve Core"),
     ...
     * override -datadir in the solidreserve.conf file in the default data directory
     * (to be consistent with solidreserved behavior)
     */
    if (dataDir != getDefaultDataDirectory())
