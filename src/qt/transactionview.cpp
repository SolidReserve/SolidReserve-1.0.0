...
void TransactionView::changedAmount(const QString& amount)
{
    ...
    // Replace "," by "." so SolidreserveUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if (SolidreserveUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed)) {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(SolidreserveUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(SolidreserveUnits::formatWithUnit(nDisplayUnit, amount, true, SolidreserveUnits::separatorAlways));
