                                                  ...
                                                  model(0)
{
    ...
    // normal solidreserve address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying solidreserve address(es)
    ui->payTo_is->setFont(GUIUtil::solidreserveAddressFont());
...
void SendCoinsEntry::clear()
{
    ...
    // update the display unit, to not use the default ("OLID")
    updateDisplayUnit();
}
