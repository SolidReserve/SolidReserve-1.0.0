...
#ifndef SOLIDRESERVE_QT_RPCCONSOLE_H
#define SOLIDRESERVE_QT_RPCCONSOLE_H
...
/** Local Solidreserve RPC console. */
...
public slots:
    ...
    void showRepair();
    /** Open external (default) editor with solidreserve.conf */
    void showConfEditor();
...
#endif // SOLIDRESERVE_QT_RPCCONSOLE_H
