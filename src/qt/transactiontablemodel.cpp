...
{
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Address") << SolidreserveUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
    priv->refreshWallet();
...
{
    columns[Amount] = SolidreserveUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord* wtx, bool showUnconfirmed, SolidreserveUnits::SeparatorStyle separators) const
{
    QString str = SolidreserveUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->debit, false, separators);
    if (showUnconfirmed) {
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, SolidreserveUnits::separatorAlways);
        }
        break;
    case Qt::EditRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, SolidreserveUnits::separatorNever);
    case StatusRole:
