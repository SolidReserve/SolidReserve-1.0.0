/* src/config/solidreserve-config.h.  Generated from solidreserve-config.h.in by configure.  */
/* src/config/solidreserve-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.solidreserve.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "solidreserve Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "solidreserve Core 4.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "solidreserve"
