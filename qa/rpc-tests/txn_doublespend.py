...
class TxnMallTest(SolidreserveTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 OLID:
        ...
        # First: use raw transaction API to send 1210 OLID to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50OLID for another
        ...
        # Node0's total balance should be starting balance, plus 100OLID for 
