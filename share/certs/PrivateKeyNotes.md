...
unlocked to sign the Solidreserve-Qt.app bundle.
...
allowing somebody to distribute a Solidreserve-Qt.app or solidreserve-qt-setup.exe with a valid
...
that the solidreserve-qt.exe file inside the installer had not been tampered with.
