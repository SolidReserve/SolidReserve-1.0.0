Contributing to solidreserve Core
============================

The SolidReserve Core project operates an open contributor model where anyone is
...
The following applies to code changes to the solidreserve Core project, and is not to be
confused with overall solidreserve Network Protocol consensus changes.

Whether a pull request is merged into solidreserve Core rests with the project merge
...
Patches that change solidreserve consensus rules are considerably more involved than
...
Where a patch set proposes to change the solidreserve consensus, it must have been
...
The project leader is the release manager for each solidreserve Core release.
