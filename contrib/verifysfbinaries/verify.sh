...
###   This script attempts to download the signature file SHA256SUMS.asc from solidreserve.org
...
WORKINGDIR="/tmp/solidreserve"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://solidreserve.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://solidreserve.org/bin/"
VERSIONPREFIX="solidreserve-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'solidreserve-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[solidreserve-]<version>-[rc[0-9]] (example: solidreserve-0.9.2-rc1)"
   echo "wget output:"
