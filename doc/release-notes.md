solidreserve Core version 2.3.0 is now available from:

  <https://github.com/solidreserve-project/solidreserve/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/solidreserve-project/solidreserve/issues>

Compatibility
==============

solidreserve Core is extensively tested on multiple operating systems using
...
solidreserve Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) solidreserve MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode solidreserve address
...
solidreserve Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for solidreserve (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with solidreserve (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/solidreserve-project-translations/).
