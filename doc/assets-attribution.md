The following is a list of assets used in the solidreserve source and their proper attribution.
...
* License: MIT
* Site: [https://solidreservetalk.org/index.php?topic=15276.0](https://solidreservetalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original solidreserve logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/solidreserve.icns, src/qt/res/src/solidreserve.svg,
	src/qt/res/src/solidreserve.ico, src/qt/res/src/solidreserve.png,
	src/qt/res/src/solidreserve_testnet.png, docs/solidreserve_logo_doxygen.png,
